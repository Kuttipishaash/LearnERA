...
public class AnnouncementsRSETAdapter extends RecyclerView.Adapter<AnnouncementsRSETAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            announcementRSETTextView = (TextView) itemView.findViewById(R.id.announcement_rset);
            announcementdateRSETTextView = (TextView) itemView.findViewById(R.id.announcement_date_rset);
        }
    }
}
