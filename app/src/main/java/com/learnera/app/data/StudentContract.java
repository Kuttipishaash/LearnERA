...
public final class StudentContract {
    ...
    public static String CONTENT_AUTHORITY="com.learnera.app";
    public static final Uri BASE_CONTENT_URI = Uri.parse("content://" + CONTENT_AUTHORITY);

    private StudentContract(){}

    public static final class AnnouncementsGeneral implements BaseColumns{
        public static String PATH_ANNOUNCEMENTS="announcements";
        public static final Uri CONTENT_URI = Uri.withAppendedPath(BASE_CONTENT_URI, PATH_ANNOUNCEMENTS);
